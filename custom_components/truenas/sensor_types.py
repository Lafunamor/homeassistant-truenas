...
SENSOR_TYPES: tuple[TrueNASSensorEntityDescription, ...] = (
    ...
    # UPS. Populated from the reporting graphs only when the UPS service is
    # configured, so these entities do not appear on a NAS without one.
    TrueNASSensorEntityDescription(
        key="ups_charge",
        name="UPS charge",
        icon="mdi:battery",
    ...
    TrueNASSensorEntityDescription(
        ...
        ha_group="System",
        data_path="ups",
        data_attribute="voltage_battery",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="ups_voltage_input",
        ...
        ha_group="System",
        data_path="ups",
        data_attribute="voltage_input",
        data_name="",
        data_uid="",
        data_reference="",
    ),
    TrueNASSensorEntityDescription(
        key="ups_voltage_output",
